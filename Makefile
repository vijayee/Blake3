...
libblake3: build
	clang -o build/lib/blake3.o -c Blake3/c/blake3.c
	clang -o build/lib/blake3_dispatch.o -c Blake3/c/blake3_dispatch.c
	clang -o build/lib/blake3_portable.o -c Blake3/c/blake3_portable.c
	clang -o build/lib/blake3_sse2_x86-64_unix.o -c Blake3/c/blake3_sse2_x86-64_unix.S
	clang -o build/lib/blake3_sse41_x86-64_unix.o -c Blake3/c/blake3_sse41_x86-64_unix.S
	clang -o build/lib/blake3_avx2_x86-64_unix.o -c Blake3/c/blake3_avx2_x86-64_unix.S
	clang -o build/lib/blake3_avx512_x86-64_unix.o -c Blake3/c/blake3_avx512_x86-64_unix.S
...
test: libblake3
	ponyc Blake3/test -o build/test --debug
	./build/test/test
